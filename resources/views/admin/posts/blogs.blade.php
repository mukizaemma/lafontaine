            ...
            <div class="container-fluid px-4">
                ...
                <div class="card mb-4">
                    <div class="card-header">
                        ...
                        <a href="{{ route('getCategories') }}" class="btn btn-dark">Topics</a>
                    </div>
                    <div class="card-body">
                        <!-- Tabs for filtering -->
                                                    ...
                                                    <div class="d-flex align-items-center">
                                                        @if ($rs->status !== "Published")
                                                            <a href="{{ route('publishBlog', $rs->id) }}" class="btn btn-primary text-black mr-2" 
                                                                onclick="return confirm('Are you sure to publish this Publication?')">
                                                                Publish
                                                            </a>
                                                        @else
                    ...
                    <div class="modal-dialog modal-lg">
                        <div class="modal-content">
                            ...
                            <div class="modal-header">
                                <h4 class="modal-title">Adding New Article</h4>
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <div class="row mb-3">
                                            <div class="col-lg-4 col-sm-12">
                                                <label for="title" class="form-label">Topics</label>
                                        ...
                                        <div class="row">
                                            <div class="col-lg-12">
                                                <label for="summernote" class="form-label">Article Details</label>
