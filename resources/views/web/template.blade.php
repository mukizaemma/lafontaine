...
<body>
        ...
        <div class="tpoffcanvas">
            ...
            <div class="tpoffcanvas__contact-info">
                ...
                <ul>
                    ...
                    <a href="https://www.google.com/maps/@23.8223586,90.3661283,15z" target="_blank">{{ $setting->address ?? '' }}</a>
                    </li>
                    <li>
                ...
                <div class="row align-items-center">
                    <div class="col-xl-2 col-lg-6 col-md-4 col-7">
                        <div class="tp-header-3__logo">
                            <a href="{{ route('home') }}">
                                <img src="{{ asset('storage/images') . ($setting->logo ?? '') }}" alt="" style="width: 200px; height:100%;">
                            </a>
                        </div>
                    </div>
                        ...
                        <div class="tp-header-3__main-menu">
                            <nav class="tp-main-menu-content">
                                <ul>
                                    ...
                                    <li class="has-dropdown"><a href="donation-details.html">Our Work</a>
                                        <ul class="submenu tp-submenu">
                                            <li><a href="donation-1.html">Donation 01</a></li>
                                        </ul>
                                    </li>
                                    <li class="has-dropdown"><a href="evant-details.html">Our Projects</a>
                                        <ul class="submenu tp-submenu">
                                            <li><a href="">Project 1</a></li>
                                        </ul>
                                    </li>
                                    <li class="has-dropdown"><a href="blog-details.html">Impact</a>
                                        <ul class="submenu tp-submenu">
                                ...
                                <ul class="d-flex align-items-center justify-content-end">
                                    <li>
                                        <div class="tp-header-3__icon-box d-none d-md-block">
                                            <button class="search-open-btn"><i class="flaticon-loupe"></i></button><a href="login.html"><i class="flaticon-user"></i></a>
                                        </div>
                                    </li>                                    
                                    <li>
    ...
    <main>
                ...
                <div class="swiper-container tp-slider-3__active">
                    <div class="swiper-wrapper">
                        <div class="swiper-slide">
                            <div class="tp-slider-3__bg z-index fix p-relative" data-background="assets/img/slider/slider-bg-3-1.jpg">
                                <div class="tp-slider-3__shape">
                                    <img src="assets/img/slider/slider-shape-3-1.png" alt="">
                                </div>
                                <div class="tp-slider-3__text">
                                    <h3 class="tp-slider-3__big-text">POOREX</h3>
                                </div>
                                <div class="container">
                                    <div class="row">
                                        <div class="col-xl-12">
                                            <div class="tp-slider-3__content text-center">
                                                <span class="tp-slider-3-subtitle">START donate on our charity</span>
                                                <h2 class="tp-slider-3-title pb-30">It's Easier To <br>Take Than To Give</h2>
                        ...
                        <div class="swiper-slide">
                            <div class="tp-slider-3__bg z-index fix p-relative" data-background="assets/img/slider/slider-bg-3-2.jpg">
                                <div class="tp-slider-3__shape">
                                    <img src="assets/img/slider/slider-shape-3-1.png" alt="">
                                </div>
                                <div class="tp-slider-3__text">
                        ...
                        <div class="swiper-slide">
                            <div class="tp-slider-3__bg z-index fix p-relative" data-background="assets/img/slider/slider-bg-3-3.jpg">
                                <div class="tp-slider-3__shape">
                                    <img src="assets/img/slider/slider-shape-3-1.png" alt="">
                                </div>
                                <div class="tp-slider-3__text">
                ...
                <div class="row">
                    <div class="col-xl-12">
                        <div class="tp-service-3__section-title text-center pb-40">
                            ...
                            <h4 class="tp-section-title">We do it for People in need</h4>
                        </div>
                    </div>
                </div>
                <div class="row">
                    ...
                    data-wow-delay=".3s">
                        <div class="tp-service-3__item p-relative">
                            ...
                            <div class="tp-service-3__content text-center">
                                <a href="about-us.html"><h4 class="tp-service-3__title-sm">Healthy Food</h4></a>
                                <p>Curabitur eu doi sollicitudin <br>augue venenatis, conseq <br>massa. Lorem ipsum</p>
                    ...
                    data-wow-delay=".5s">
                        <div class="tp-service-3__item p-relative">
                            ...
                            <div class="tp-service-3__content text-center">
                                <a href="about-us.html"><h4 class="tp-service-3__title-sm">Kids Education</h4></a>
                                <p>Curabitur eu doi sollicitudin <br>augue venenatis, conseq <br>massa. Lorem ipsum</p>
                                <a href="about-us.html">Read More</a>
                                <div class="tp-service-3__shape">
                                    <img src="assets/img/service/service-shape.png" alt="">
                    ...
                    data-wow-delay=".7s">
                        <div class="tp-service-3__item p-relative">
                            <div class="tp-service-3__thumb-box p-relative">
                                <div class="tp-service-3__thumb">
                                    <img src="assets/img/service/service-3-3.jpg" alt="">
                                </div>
                                <div class="tp-service-3__icon">
                                    <span><i class="flaticon-drops"></i></span>
                                </div>
                            </div>
                            <div class="tp-service-3__content text-center">
                                <a href="about-us.html"><h4 class="tp-service-3__title-sm">Pure Water</h4></a>
                                <p>Curabitur eu doi sollicitudin <br>augue venenatis, conseq <br>massa. Lorem ipsum</p>
                                <a href="about-us.html">Read More</a>
                                <div class="tp-service-3__shape">
                                    <img src="assets/img/service/service-shape.png" alt="">
                    ...
                    data-wow-delay=".9s">
                        <div class="tp-service-3__item p-relative">
                            <div class="tp-service-3__thumb-box p-relative">
                                <div class="tp-service-3__thumb">
                                    <img src="assets/img/service/service-3-4.jpg" alt="">
                                </div>
                                <div class="tp-service-3__icon">
                            ...
                            <div class="tp-service-3__content text-center">
                                <a href="about-us.html"><h4 class="tp-service-3__title-sm">Medical Care</h4></a>
                                <p>Curabitur eu doi sollicitudin <br>augue venenatis, conseq <br>massa. Lorem ipsum</p>
                                <a href="about-us.html">Read More</a>
                                <div class="tp-service-3__shape">
                                    <img src="assets/img/service/service-shape.png" alt="">
                    ...
                    data-wow-delay=".3s">
                        <div class="tp-about-3__main-thumb p-relative">
                            ...
                            <div class="tp-about-3__thumb-sm">
                                <img src="assets/img/about/about-3-3.jpg" alt="">
                            </div>
                    ...
                    data-wow-delay=".9s">
                        <div class="tp-about-3__left-side">
                            <div class="tp-about-3__section-title">
                                <span class="tp-section-subtitle-3">KNOW ABOUT OUR POOREX</span>
                                <h4 class="tp-section-title">Helping each other can <br>make world better</h4>
                            </div>
                            <div class="tp-about-3__content">
                                <div class="tp-about-3__text">
                                    <p>Charity is the act of extending love and kindness to others unconditional which
                                        <br> is a conscious act but the decision is made by the heart, without expecting
                                        a <br> reward. When Charity is carried out selflessly
                                    </p>
                                </div>
                                <div class="tp-about-3__text-2 d-flex align-items-center">
                                    <span><i class="flaticon-volunteer"></i></span>
                                    <p>You can use Charity Navigator to find and su thousands of <br>charities that align your passions </p>
                                </div>
                                    ...
                                    <div class="tp-about-3__progress-item fix">
                                        ...
                                        <div class="progress">
                                            <div class="progress-bar wow slideInLeft" data-wow-duration="1s"
                                                data-wow-delay=".3s" role="progressbar" data-width="82%"
                                ...
                                <div class="tp-about-3__wraper pb-40 d-flex justify-content-between">
                                    <div class="tp-about-3__list-item d-flex about-items-start">
                                        ...
                                        <div class="tp-about-3__list-content">
                                            <h4 class="tp-about-3__title-sm">Quick Fundraising</h4>
                                            <p>Charity Navigator's Giving you <br> support multiple</p>
                                        </div>
                                    </div>
                                    <div class="tp-about-3__list-item d-flex align-items-start">
                                        <div class="tp-about-3__list-icon">
                                            <i class="flaticon-check-mark-black-outline"></i>
                                        </div>
                                        <div class="tp-about-3__list-content">
                                            <h4 class="tp-about-3__title-sm">Join Our Team</h4>
                                            <p>Charity Navigator's Giving you <br> support multiple</p>
                                        </div>
                                    </div>
                                </div>                                
                    ...
                    <div class="row align-items-end">
                        <div class="col-xl-8 col-lg-8 col-md-8">
                            <div class="tp-donate__section-title">
                                <span class="tp-section-subtitle-3">Help the people</span>
                    ...
                    <div class="swiper-container tp-donate__active">
                        <div class="swiper-wrapper">
                            <div class="swiper-slide">
                                <div class="tp-donate__item">
                                    <div class="tp-donate__thumb p-relative fix">
                                        <img src="assets/img/donate/donate-3-1.png" alt="">
                                    ...
                                    <div class="tp-donate__content">
                                        <div class="tp-donate__text">
                                            <a href="donation-details.html">
                                                <h5 class="tp-donate__title">Contribute Make For The Somalians happy
                                                </h5>
                                            </a>
                                        ...
                                        <div class="tp-donate__button">
                                            <a class="tp-grey-btn" href="donation-sidebar.html">Donate Now</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="swiper-slide">
                                <div class="tp-donate__item">
                                    <div class="tp-donate__thumb p-relative fix">
                                        <img src="assets/img/donate/donate-3-2.png" alt="">
                                        <div class="tp-donate__thumb-shape">
                                            <img src="assets/img/donate/donate-shape-1.png" alt="">
                                            <div class="tp-donate__thumb-text">
                                                <span>CHARITY</span>
                                    ...
                                    <div class="tp-donate__content">
                                        <div class="tp-donate__text">
                                            <a href="donation-details.html">
                                                <h5 class="tp-donate__title">Give African Child A Good
                                                    Education</h5>
                                            </a>
                                            <p>Street children are poor or home children who live on the streets </p>
                                        </div>
                                        <div class="tp-donate-progress">
                                            <div class="tp-donate-progress-item fix">
                                                <span class="progress-count">64%</span>
                                                <div class="progress">
                                                    <div class="progress-bar wow slideInLeft" data-wow-duration="1s"
                                                        data-wow-delay=".3s" role="progressbar" data-width="64%"
                                                        aria-valuenow="25" aria-valuemin="0" aria-valuemax="100"
                                                        style="width: 58%; visibility: visible; animation-duration: 1s; animation-delay: 0.3s; animation-name: slideInLeft;">
                                                    </div>
                                                </div>
                            ...
                            <div class="swiper-slide">
                                <div class="tp-donate__item">
                                    <div class="tp-donate__thumb p-relative fix">
                                        <img src="assets/img/donate/donate-3-3.png" alt="">
                                        <div class="tp-donate__thumb-shape">
                                            <img src="assets/img/donate/donate-shape-1.png" alt="">
                                            <div class="tp-donate__thumb-text">
                                                <span>FOOD</span>
                                    ...
                                    <div class="tp-donate__content">
                                        <div class="tp-donate__text">
                                            <a href="donation-details.html">
                                                <h5 class="tp-donate__title">Raise Fund For Clean &
                                                    Healthy Food</h5>
                                            </a>
                                            <p>Street children are poor or home children who live on the streets </p>
                                        </div>
                            ...
                            <div class="swiper-slide">
                                <div class="tp-donate__item">
                                    <div class="tp-donate__thumb p-relative fix">
                                        <img src="assets/img/donate/donate-1-2.png" alt="">
                                        <div class="tp-donate__thumb-shape">
                                            <img src="assets/img/donate/donate-shape-1.png" alt="">
                                            <div class="tp-donate__thumb-text">
                                                <span>CHARITY</span>
                    ...
                    <div class="row">
                        <div class="col-xl-12">
                            <div class="tp-cta-2__content text-center">
                                ...
                                data-wow-delay=".7s">Start Donating Now</a>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="tp-testimonial-3__area pb-120">
            <div class="container">
                <div class="row">
                    <div class="col-xl-12">
                                ...
                                <div class="swiper-wrapper">
                                        ...
                                        <div class="tp-testimonial-3__item">
                                            <div class="tp-testimonial-3__top d-flex align-items-center justify-content-between">
                                                ...
                                                <div class="tp-testimonial-3__top-text">
                                                    <p>We, the People, recognize that we responsibilities <br>as well as rights; thatdestinies are bound  that a <br>freedom which only asks </p>
                                                </div>
                                            </div>
                                            <div class="tp-testimonial-3__bottom d-flex align-items-center justify-content-between">
                                                <div class="tp-testimonial-3__author-info">
                                                    <h4 class="tp-testimonial-3__author-name">Charlotte Ava</h4>
                                                    <span>Customer</span>
                                                </div>
                                    ...
                                    <div class="swiper-slide">
                                        <div class="tp-testimonial-3__item">
                                            ...
                                            <div class="tp-testimonial-3__bottom d-flex align-items-center justify-content-between">
                                                <div class="tp-testimonial-3__author-info">
                                                    <h4 class="tp-testimonial-3__author-name">Paul Pitterson</h4>
                                                    <span>Customer</span>
                                                </div>
                                                <div class="tp-testimonial-3__bottom-right d-none d-sm-block">
                                    ...
                                    <div class="swiper-slide">
                                        <div class="tp-testimonial-3__item">
                                            ...
                                            <div class="tp-testimonial-3__bottom d-flex align-items-center justify-content-between">
                                                <div class="tp-testimonial-3__author-info">
                                                    <h4 class="tp-testimonial-3__author-name">Alisha  Ava</h4>
                                                    <span>Customer</span>
                                                </div>
                                                <div class="tp-testimonial-3__bottom-right d-none d-sm-block">
                                                    <img src="assets/img/testimonial/testi-shape-3-1.png" alt="">
        ...
        <div class="tp-about-4__area tp-about-4__space p-relative fix grey-bg">
            <div class="tp-about-4__bg" data-background="assets/img/about/about-3-4.jpg">
                    ...
                    data-wow-delay=".5s">
                        <div class="tp-about-4__left-side">
                            <div class="tp-about-4__section-title">
                                <span class="tp-section-subtitle-3">HELPING HANDS</span>
                                <h4 class="tp-section-title">Raise Fund for Clean <br>& Healthy Food</h4>
                            </div>
                            <div class="tp-about-4__content">
                                <div class="tp-about-4__text">
                                    <p>Supporting personal fundraisers can be a beautiful experience or a <br>horrifying one. Here is what you need to 
                                    </p>
                                </div>                                
                                <div class="tp-about-4__wraper pb-45 d-flex justify-content-between">
                                    <div class="tp-about-4__list-item d-flex align-items-start">
                                        ...
                                        <div class="tp-about-4__list-content">
                                            ...
                                            <p>When we longer able to <br>change situation</p>
                                        </div>
                                    </div>
                                    <div class="tp-about-4__list-item d-flex align-items-start">
                                        <div class="tp-about-4__list-icon">
                                ...
                                <div class="tp-about-4__progress mb-40">
                                    <div class="tp-about-4__progress-item fix">
                                        <h4>Charity</h4>
                                        <span class="progress-count">78%</span>
                                        <div class="progress">
                                            <div class="progress-bar wow slideInLeft" data-wow-duration="1s"
                                                data-wow-delay=".3s" role="progressbar" data-width="78%"
                                                aria-valuenow="25" aria-valuemin="0" aria-valuemax="100"
                                                style="width: 58%; visibility: visible; animation-duration: 1s; animation-delay: 0.3s; animation-name: slideInLeft;">
                                            </div>
                                        </div>
                ...
                <div class="row">
                        ...
                        <div class="tp-blog-2__item">
                            ...
                            <div class="tp-blog-2__content">
                                <div class="tp-blog-2__tag">
                                    <span><i class="flaticon-tag"></i>FOOD</span>
                                </div>
                                <a href="blog-details.html"><h4 class="tp-blog-2__title-sm">Our Donation is Hope For <br>Poor Childrens.</h4></a>
                                <span class="tp-blog-2__meta-3">OCTOBER 24, 2022</span>
                                <a href="blog-details.html">
                    ...
                    data-wow-delay=".5s">
                        <div class="tp-blog-2__item">
                            ...
                            <div class="tp-blog-2__content">
                                <div class="tp-blog-2__tag">
                                    <span><i class="flaticon-tag"></i>CHARITY</span>
                                </div>
                                <a href="blog-details.html"><h4 class="tp-blog-2__title-sm">10 Ways To Give Charity <br>Without Your Budget.</h4></a>
                                <span class="tp-blog-2__meta-3">OCTOBER 24, 2022</span>
                                <a href="blog-details.html">
                                    <div class="tp-blog-2__link text-center">
                                        <span>Read More<i class="flaticon-arrow-right"></i><span>
                    ...
                    data-wow-delay=".7s">
                        <div class="tp-blog-2__item">
                            ...
                            <div class="tp-blog-2__content">
                                <div class="tp-blog-2__tag">
                                    <span><i class="flaticon-tag"></i>HEALTH</span>
                                </div>
                                <a href="blog-details.html"><h4 class="tp-blog-2__title-sm">Condolence To Families <br>Effected By Flash Food</h4></a>
                                <span class="tp-blog-2__meta-3">OCTOBER 24, 2022</span>
                                <a href="blog-details.html">
                                    <div class="tp-blog-2__link text-center">
                                        <span>Read More<i class="flaticon-arrow-right"></i><span>
        ...
        <!-- gallery-area-start -->
        <div class="tp-gallery-3__area tp-gallery-3__space">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 mb-30 wow tpfadeLeft" data-wow-duration=".9s"
                    data-wow-delay=".3s">
                        <div class="tp-gallery-3__item p-relative">
                            <img src="assets/img/gallery/gal-3-1.jpg" alt="">
                            <div class="tp-gallery-3__icon">
                                <a class="popup-image" href="assets/img/gallery/gal-3-1.jpg">
                    ...
                    data-wow-delay=".5s">
                        <div class="tp-gallery-3__item p-relative">
                            <img src="assets/img/gallery/gal-3-2.jpg" alt="">
                            <div class="tp-gallery-3__icon">
                                <a class="popup-image" href="assets/img/gallery/gal-3-2.jpg">
                                    <svg id="body4" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="49" height="51" viewBox="0 0 49 51">
                                        <g id="gallery2">
                                          <g id="_03_hover" data-name="02 + hover">
                                            <g id="go_icon4" data-name="go icon">
                    ...
                    data-wow-delay=".7s">
                        <div class="tp-gallery-3__item p-relative">
                            <img src="assets/img/gallery/gal-3-5.jpg" alt="">
                            <div class="tp-gallery-3__icon">
                                <a class="popup-image" href="assets/img/gallery/gal-3-5.jpg">
                    ...
                    data-wow-delay=".9s">
                        <div class="tp-gallery-3__item p-relative">
                            <img src="assets/img/gallery/gal-3-3.jpg" alt="">
                            <div class="tp-gallery-3__icon">
                                <a class="popup-image" href="assets/img/gallery/gal-3-3.jpg">
                                    <svg id="body99" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="49" height="51" viewBox="0 0 49 51">
                                        <g id="gallery5">
    ...
    <footer>
        ...
        <div class="tp-footer__area">
            <div class="tp-footer__bg" data-background="assets/img/footer/ft-bg-1.jpg">
                <div class="container">
                    <div class="row">
                        <div class="col-xl-4 col-lg-4 col-md-6 col-sm-12 mb-45 wow tpfadeUp" data-wow-duration=".9s"
                    data-wow-delay=".3s">
                            <div class="tp-footer__widget footer-2-col-1">
                                <div class="tp-footer__logo">
                                    <a href="{{ route('home') }}">
                                        <img src="{{ asset('storage/images') . ($setting->logo ?? '') }}" alt="" width="200px">
                                    </a>
                                </div>
                                ...
                                <div class="tp-footer__contact-lists">
                                    <div class="row align-items-center">
                                        <div class="col-12 mt-5">
                                            <div class="tp-copyright__socials text-center text-sm-start">
                                                <a href="{{ $setting->facebook ?? '' }}" class="btn btn-secondary"><i class="fab fa-facebook-f"></i></a>
                                                <a href="{{ $setting->instagram ?? '' }}" class="btn btn-secondary"><i class="fab fa-instagram"></i></a>
                                                <a href="{{ $setting->twitter ?? '' }}" class="btn btn-secondary"><i class="fab fa-twitter"></i></a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="col-xl-8 col-lg-8 col-md-6 col-sm-12 mb-45 wow tpfadeUp" data-wow-duration=".9s"
                    data-wow-delay=".9s">
                        <div class="row">
                            <div class="container">
                            ...
                            <div class="col-lg-6 col-sm-12">
                                <div class="tp-footer__widget footer-2-col-4">
                                    <div class="tp-footer__donate-box">
                                        <a class="tp-btn theme-2-bg" href="{{ $setting->donate ?? '' }}" style="border-radius:7px;">Get Involved</a>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-6 col-sm-12">
                                <div class="tp-footer__widget footer-2-col-4">
                                    <div class="tp-footer__donate-box">
                                        <a class="tp-btn theme-2-bg" href="{{ $setting->donate ?? '' }}" style="border-radius:7px;">Donate</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="row align-items-center">
                    <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                        <div class="tp-copyright__text text-center text-sm-start">
                            <span>©  <script>document.write(new Date().getFullYear()) </script>, {{ $setting->company ?? '' }} | Delivered by <a href="https:://iremetech.com">Ireme Technologies</a></span>
                        </div>
                    </div>
                </div>
            </div>
