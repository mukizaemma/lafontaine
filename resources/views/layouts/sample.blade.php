                ...
                <div class="container">
                    ...
                    data-wow-delay=".5s">
                            <div class="tp-footer__widget footer-2-col-2">
                                <h4 class="tp-footer__widget-title-3">Navigation</h4>
                    ...
                    data-wow-delay=".7s">
                            <div class="tp-footer__widget footer-2-col-3">
                                <h4 class="tp-footer__widget-title-3">Campaigns</h4>
                                <div class="tp-footer__list">
                                    <ul>
                    ...
                    data-wow-delay=".9s">
                            <div class="tp-footer__widget footer-2-col-4">
                                <div class="tp-footer__donate-box">
                                    ...
                                    <a class="tp-btn theme-2-bg" href="donation-sidebar.html">Donate Now</a>
                                </div>
                            </div>
                        </div>
                    </div>
